const ownerNumber = ["5521974938838@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '5521974938838' 
...
const apiTobz = 'h1oDZreuPhUUtgcFLzCh'
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5521974938838:+55 21 97493-8838\n' 
+ 'END:VCARD'
